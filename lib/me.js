    ...
    setTemplate(templateId) {
        if (this.templateId !== templateId) {
            ...
            if (UserData) {
                ...
                // no DataCenter table (running under the Noctenium bridge), derive from templateId like the library mod
                this.race = Math.floor((this.templateId - 10101) / 100);
                this.class = (this.templateId - 10101) % 100;
                this.gender = this.race % 2;
                this.parent.mod.log(`Derived race/class/gender from template ID ${this.templateId} (no DataCenter template data)`);
            }
